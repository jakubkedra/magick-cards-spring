...
public class CardController {
    ...
    @DeleteMapping("collection/delete/{card}/{username}")
    public ResponseEntity<List<CardModel>> getCardsFromUserCollection(@PathVariable String username, @PathVariable String card) {
        return cardService.deleteCardById(username, card);
    }
}
